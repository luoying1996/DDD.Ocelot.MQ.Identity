<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CZ_Pay.aspx.cs" Inherits="WS.EKA.Portal.wxpay.CZ_Pay" %>
...
<head>
    ...
    <script type="text/javascript" src="/Scripts/lazyloadv3.js"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
            ...
            $('a#getBrandWCPayRequest').click(); //信内置浏览器完成内部初始化调用支付方法
        ...
        function OrderPay() {
            ...
            $.ajax({
                    ...
                    url: "/api/weixinorderupdatepayment/?id="+out_trade_no,
...
<body>
    <div class="WCPay">
        ...
        <input type="hidden" id="txt_out_trade_no" value="<%=out_trade_no %>" />
    </div>
</body>
</html>

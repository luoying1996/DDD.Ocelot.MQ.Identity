window.DevelopMemberView = Backbone.View.extend({
    ...
    SetImgQrc: function () {
        ...
        var commendUrl = "http://" + window.location.host + "/%23page/QRCodeRegister?CommendPeople=" + pageView.getCookieValue('uid');
        var tmpUrl = QrcUrl + commendUrl;
        console.log(tmpUrl);
        imageQrc.attr("src", tmpUrl);
    },
});

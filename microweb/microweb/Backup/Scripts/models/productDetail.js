...
function GetProductDetai(ProductGuid) {
    ...
    $.ajax({
		...
		data: { AgentID: agentId, Sbool: pageView.getCookieValue("Sbool"), Id: ProductGuid, MemLoginID: MemLoginID },
        ...
        success: function (result) {
            ...
            //mobile detail
            //alert(HtmlUtil.htmlDecodeByRegExp(result.MobileDetail));
            $("#div_daitaTxt").html(HtmlUtil.htmlDecodeByRegExp(result.MobileDetail));
        ...
        $(this).find("a").click(function () {
            ...
            if (CheckProductSpecification()) {
                ...
                $.ajax({
					...
					data: { MemLoginID: pageView.getCookieValue('uid'), AgentID: agentId, Sbool: pageView.getCookieValue('Sbool') },
                    dataType: "json",
                    success: function (data) {
                        if (data.toString() != "") {
...
function AddProductShop() {
    ...
    var specNum = $("#hidSpecRepertoryCount").val() || "0";

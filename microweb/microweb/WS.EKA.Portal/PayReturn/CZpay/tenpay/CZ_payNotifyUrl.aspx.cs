...
namespace WS.EKA.Portal.PayRetrun.CZpay.tenpay
{
    public partial class CZ_payNotifyUrl : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (resHandler.isTenpaySign())
            {
                ...
                if (pay_result == "0")
                {
                    ...
                    //处理业务开始
                    //------------------------------
                    var dic = CommonRequest.ApiUpdateRechargeByOrderNumber(sp_billno);
                    //注意交易单不要重复处理
                    //注意判断返回金额

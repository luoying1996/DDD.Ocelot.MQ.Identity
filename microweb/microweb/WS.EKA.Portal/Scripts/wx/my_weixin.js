...
function WeiXinLoad() {
    ...
    wx.ready(function () {
        ...
        var img = link.split("#")[0] + "/images/IdxIcn02.png";
...
function DomianWeiXinLoad() {
    var url = window.location.href;
    url = url.split('#')[0];
    url = encodeURIComponent(url);

    var req = "/api/weixinload/?url=" + url;
        ...
        success: function (res) {
            ...
            if (res.RESULT == "200") {
                wx.config({
                    ...
                    signature: res.signatrue,// 必填，签名，见附录1

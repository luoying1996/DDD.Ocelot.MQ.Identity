...
window.WeixinPageView = Backbone.View.extend({
    ...
    render: function () {
        ...
        if (localStorage.getItem("Sbool") != null && localStorage.getItem("Sbool") != undefined) {
            $.ajax({
                url: '/api/WeiXinLogin/' + localStorage.getItem('login') + "/" + localStorage.getItem("AgentID") + "/" + localStorage.getItem("Sbool"),
                dataType: 'json',
                async: false,
...
window.PageView = Backbone.View.extend({
    ...
    render: function () {
        ...
        if (pageId == 'ProductDetail') {
            ...
            pageId = 'weixin?' + localStorage.getItem('login') + '&' + localStorage.getItem('AgentID') + "&" + localStorage.getItem('Sbool');
            this.goTo('Catalog');
        }
    ...
    goTo: function (pageId) {
        ...
        if (str[0] == 'ProductDetail') { pageId = str[0]; localStorage.setItem('productid', str[1]); }
            ...
            localStorage.setItem('AgentID', pageId3[1]);

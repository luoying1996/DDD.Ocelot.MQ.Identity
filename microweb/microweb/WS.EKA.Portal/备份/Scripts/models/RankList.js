...
function LoadRankList(RankType) {
    ...
    $.ajax({
        ...
        url: "/api/product/type/?type=" + type + "&sorts=" + sorts + "&isASC=" + isASC + "&pageIndex=" + pageIndex + "&pageCount=" + pageCount + "&agentID=" + pageView.getCookieValue('AgentID') + "&sbool=" + localStorage.getItem('Sbool'),
